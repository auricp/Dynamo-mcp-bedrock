...
}, async ({ tableName, item }: { tableName: string, item: Record<string, any> }) => {
...
}, async ({ tableName, key }: { tableName: string, key: Record<string, any> }) => {
...
}, async ({ tableName, keyConditionExpression, expressionAttributeValues }: { tableName: string, keyConditionExpression: string, expressionAttributeValues: Record<string, any> }) => {
